...
| Project | Description |
|---------|-------------|
| [cc-mission-control](https://github.com/bencode/cc-mission-control) | Mission-control dashboard for Claude Code sessions in WezTerm — live terminal thumbnails, status at a glance |
